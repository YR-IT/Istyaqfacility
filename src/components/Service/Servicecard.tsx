  ...
  return (
    <div className="relative group bg-white/80 backdrop-blur-lg shadow-lg border border-[#b59e6f]/30 hover:border-[#b59e6f] rounded-3xl transition-transform duration-500 hover:-translate-y-2 overflow-visible">
      ...
      <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 z-10">
        <div className="w-16 h-16 bg-white text-black rounded-full flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
      ...
      <div className="pt-20 pb-8 px-6 flex flex-col items-center text-center">
        ...
        <button className="relative group/button inline-flex items-center justify-center py-2 px-5 rounded-full bg-slate-800 text-white font-semibold border border-[#b59e6f] hover:bg-white hover:text-black transition-all duration-300 overflow-hidden">
