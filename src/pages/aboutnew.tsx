    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-8">
            <div className="space-y-6">
              <h3 className="font-playfair text-2xl md:text-3xl font-bold text-white mb-6 text-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              className="text-6xl font-bold mb-10 font-playfair relative inline-block
              after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] 
              after:w-full after:bg-black after:scale-x-0 hover:after:scale-x-100 
              after:transition-transform after:duration-300 after:origin-left text-white"
            >
              Founders
            </h2>
            <div className="flex gap-8 overflow-hidden ">
                         <img
                           src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c"
                           alt="Interior Preview"
                           className="rounded-xl w-1/2 h-full object-cover transform transition-transform duration-500 hover:scale-105"
                         />
                         <img
                           src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c"
                           alt="Interior Preview"
          ...
          <div className="text-center mt-16">
              <Link to ="/Contact">
            <button className="px-8 py-3 rounded-lg font-semibold text-black bg-white hover:bg-[#dcddde] transition-colors mb-32">
